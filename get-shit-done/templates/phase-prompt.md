...
user_setup: []              # Human-required setup the AI cannot automate (see below)
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>[What the AI built] - server running at [URL]</what-built>
...
<!-- Checkpoint pattern: Agent starts server, user visits URL. See checkpoints.md for full patterns. -->
<task type="auto">
...
**The automation-first rule:** `user_setup` contains ONLY what the AI literally cannot do:
- Account creation (requires human signup)
- Secret retrieval (requires dashboard access)
- Dashboard configuration (requires human in browser)

**NOT included:** Package installs, code changes, file creation, CLI commands the AI can run.
